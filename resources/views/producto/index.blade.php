...
@section('title', 'ELITEfox-Producto')

@section('content_header')
    <h1 class="texto-brillante text-center">Producto</h1>
@stop
...
@section('content')
    <div class="container mb-3">
        <a href="{{route('producto.create')}}" title="Crear Nuevo" class="btn btn-outline-info"><i class="fa fa-plus" aria-hidden="true"></i></a>
    </div>
