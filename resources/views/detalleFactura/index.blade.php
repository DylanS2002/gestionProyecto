...
@section('title', 'ELITEfox-Detalle Factura')

@section('content_header')
    <h1 class="texto-brillante text-center">Detalle Factura</h1>
@stop
        ...
        <tbody>
            @foreach ($detalleFacturas as $detalleFactura)
                <tr>
                    ...
                    <td>{{$detalleFactura->factura->cliente->nombre}}
                        {{$detalleFactura->factura->cliente->apellido}}
                    </td>
