...
@section('content')
    <a href="{{route('factura.create')}}" class="btn btn-outline-info mb-3"><i class="fa fa-plus" aria-hidden="true"></i></a>
    <a href="{{route('index')}}" class="btn btn-outline-primary mb-3"><i class="fa fa-reply" aria-hidden="true"></i></a>
