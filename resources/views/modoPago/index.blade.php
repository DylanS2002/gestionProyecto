...
@section('title', 'ELITEfox-Modo Pago')

@section('content_header')
    <h1 class="texto-brillante text-center">Modo Pago</h1>
@stop
...
@section('content')
    <div class="container mb-3">
        <a href="{{route('modoPago.create')}}" title="Crear Nuevo" class="btn btn-outline-info"><i class="fa fa-plus" aria-hidden="true"></i></a>
    </div>
