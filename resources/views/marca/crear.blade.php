...
@section('content_header')
    <h1 class="texto-brillante text-center">Crear Marca</h1>
@stop
    ...
    <div class="row">
        <div class="col-6">
            ...
            <form action="{{route('marca.store')}}" class="form" method="POST">
                ...
                <input type="text" name="description" id="descripcion" class="form-control @error('description') is-invalid @enderror">
