...
@section('title', 'ELITEfox-Marcas')

@section('content_header')
    <h1 class="texto-brillante text-center">Marcas</h1>
@stop
...
@section('content')
    <div class="container mb-3">
        <a href="{{route('marca.create')}}" title="Crear Nuevo" class="btn btn-outline-info"><i class="fa fa-plus" aria-hidden="true"></i></a>
    </div>
